...
export const FeedArchivePage = () => {
  ...
  const {filters, setSortBy, setViewMode, resetFilters, activeFiltersCount} = feedState
  const [localSearchQuery, setLocalSearchQuery] = React.useState(filters.search)
          ...
          <div className="flex flex-col lg:flex-row gap-4 mb-4">
            ...
            <div className="flex-1 relative group">
              ...
              <Input
                ...
                className="pl-12 pr-4 h-12 text-lg border-2 border-gray-200 focus:border-blue-500 rounded-xl shadow-sm bg-white/50 backdrop-blur-sm"
              />
              {localSearchQuery && (
                <button
                  onClick={() => {
            ...
            <div className="flex items-center gap-3">
              ...
              <Select value={filters.sortBy} onValueChange={setSortBy}>
                <SelectTrigger className="w-44 h-12 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm">
              ...
              {/* View Toggle */}
              <div className="flex rounded-xl border-2 border-gray-200 bg-white/50 backdrop-blur-sm overflow-hidden">
                <Button
              ...
              <Button
                ...
                className="lg:hidden h-12 px-4 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm relative"
              >
          ...
          {isLoading ? (
            ...
            >
              ...
              <p className="text-gray-600 mb-6 max-w-md mx-auto">
                We couldn&apos;t find any content matching your criteria. Try adjusting your search or explore different categories.
              </p>
              <Button
                onClick={resetFilters}
          ...
          <div ref={intersectionRef} className="flex justify-center py-12">
            {isFetchingNextPage ? (
              ...
              >
                ...
                <span className="text-gray-600 font-medium">Loading more amazing content...</span>
              </motion.div>
            ) : (
              <Button 
                ...
                variant="outline"
                size="lg"
                className="border-2 border-gray-200 hover:border-blue-500 hover:text-blue-600 rounded-xl px-8"
              >
                Load More Articles
              </Button>
            )}
